...
SoftwareSerial ultraSerial(9, 11); // RX on pin 2(white), TX on pin 3(yellow)
...
float volt_AC;
const int SensorPin = 11;//A0;
const int ready_calib = A1;
const int buz_Pin = A2;
const int water_full = A0;
const int water_red = 7;
const int water_yellow = 12;
const int water_blue = 13;
